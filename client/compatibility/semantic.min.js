                ...
                get: {
                    ...
                    values: function(n) {
                        ...
                        return e.isArray(n) || (n = l), e.each(n, function(n, o) {
                            var a = "string" == typeof o ? t.get.field(o) : e(o),
                            ...
                            if (r)
                                ...
                                if (!u) return t.debug("Omitted unchecked checkbox", a), !0;
                                i[r] = !0
                            } else i[r] = s
                        }), i
                    }
                    ...
                    keydown: function(e) {
                        {
                            var t, n = z.not(x.filtered).filter("." + x.selected).eq(0),
                                i = O.children("." + x.active).eq(0),
                                o = n.length > 0 ? n : i,
                                a = o.length > 0 ? o.siblings(":not(." + x.filtered + ")").andSelf() : O.children(":not(." + x.filtered + ")"),
                                r = o.children(T.menu),
                                s = o.closest(T.menu),
                                c = s[0] !== O[0],
                                l = s.is(":visible"),
                        ...
                        if (b.is.visible()) {
                            if (u == d.enter && m && (f && !y.allowCategorySelection ? (b.verbose("Pressed enter on unselectable category, opening sub menu"), u = d.rightArrow) : (b.verbose("Enter key pressed, choosing selected item"), b.event.item.click.call(o, e))), u == d.leftArrow && (c && (b.verbose("Left key pressed, closing sub-menu"), b.animate.hide(!1, s), o.removeClass(x.selected), s.closest(T.item).addClass(x.selected)), e.preventDefault()), u == d.rightArrow && (f && (b.verbose("Right key pressed, opening sub-menu"), b.animate.show(!1, r), o.removeClass(x.selected), r.find(T.item).eq(0).addClass(x.selected)), e.preventDefault()), u == d.upArrow) {
                                if (t = m && l ? o.prevAll(T.item + ":not(." + x.filtered + ")").eq(0) : z.eq(0), a.index(t) < 0) return void b.verbose("Up key pressed but reached top of current menu");
                            ...
                            if (u == d.downArrow) {
                                if (t = m && l ? t = o.nextAll(T.item + ":not(." + x.filtered + ")").eq(0) : z.eq(0), 0 === t.length) return void b.verbose("Down key pressed but reached bottom of current menu");
        ...
        return e(this).each(function() {
            ...
            m = {
                ...
                handleKeyboard: function(e) {
                    ...
                    else r == s.enter && (m.verbose("Enter key pressed, executing query"), m.query(), m.set.buttonPressed(), k.one("keyup", m.remove.buttonFocus))
                },
                setup: {
                    api: function() {
                        var e = {
                ...
                search: {
                    ...
                    object: function(t, n) {
                        var o = [],
                            ...
                            s = new RegExp(h.exact + t, "i"),
                            c = new RegExp(t, "i");
                        return n = n || g.source, n === i ? (m.error(y.source), []) : (e.each(r, function(t, i) {
                            e.each(n, function(t, n) {
                                var r = "string" == typeof n[i],
                                    l = -1 == e.inArray(n, o) && -1 == e.inArray(n, a);
            ...
            C = {
                ...
                pushPage: function(t) {
                    var n, i, o = C.get.transition(),
                        a = "safe" == o ? O : "overlay" === o || C.othersActive() ? D : q;
...
function(e, t, n, i) {
    ...
    e.fn.sticky = function(n) {
        var o, a = e(this),
            ...
            d = [].slice.call(arguments, 1);
        return a.each(function() {
            var a, f, m, g = e.extend(!0, {}, e.fn.sticky.settings, n),
                p = g.className,
                v = g.namespace,
                h = g.error,
                b = "." + v,
...
function(e, t, n, i) {
    ...
    e.fn.transition = function() {
        ...
        return a.each(function() {
            var t, m, g, p, v, h, b, y, x, w, C, T, k = e(this),
                S = this;
            T = {
                initialize: function() {
                ...
                animate: function(e) {
                    if (t = e || t, !T.is.supported()) return T.error(g.support), !1;
                    if (T.debug("Preparing animation", t.animation), T.is.animating()) {
                        if (t.queue) return !t.allowRepeats && T.has.direction() && T.is.occurring() && T.queuing !== !0 ? T.debug("Animation is currently occurring, preventing queueing same animation", t.animation) : T.queue(t.animation), !1;
                        if (!t.allowRepeats && T.is.occurring()) return T.debug("Animation is already occurring, will not execute repeated animation", t.animation), !1
                    }
        ...
        return a.each(function() {
            ...
            g = {
                ...
                query: function() {
                    ...
                    if (p.defaultData && e.extend(!0, p.urlData, g.get.defaultData()), (p.serializeForm !== !1 || S.is("form")) && ("json" == p.serializeForm ? e.extend(!0, p.data, g.get.formData()) : p.data = g.get.formData()), a = g.get.settings(), a === !1) return void g.error(y.beforeSend);
                    if (p.url ? (g.debug("Using specified url", f), f = g.add.urlData(p.url)) : (f = g.add.urlData(g.get.templateURL()), g.debug("Added URL Data to url", f)), !f) {
                        if (!T.is("form")) return void g.error(y.missingURL, p.action);
                        ...
                        error: function(t, n, o) {
                            ...
                            if (t !== i)
                                if (t.readyState !== i && 4 == t.readyState) {
                                    if (200 != t.status && o !== i && "" !== o) g.error(y.statusMessage + o);
                                ...
                                } else p.onAbort.call(P, r, T), g.debug("Request Aborted (Most likely caused by page change or CORS Policy)", n, o)
                        }
                    }
                },
                create: {
...
function(e, t, n, i) {
    e.fn.visibility = function(o) {
        var a, r = e(this),
            ...
            f = [].slice.call(arguments, 1);
        return r.each(function() {
            var r, m = e.extend(!0, {}, e.fn.visibility.settings, o),
                g = m.className,
                p = m.namespace,
                v = m.error,
                h = "." + p,
                ...
                invoke: function(t, n, o) {
                    ...
                    return n = n || f, o = k || o, "string" == typeof t && u !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function(n, o) {
                        ...
                        if (e.isPlainObject(u[a]) && n != s) u = u[a];
                            ...
                            if (!e.isPlainObject(u[o]) || n == s) return u[o] !== i ? (c = u[o], !1) : (r.error(v.method, t), !1);
                            u = u[o]
                        }
